...
[dependencies]
forge = { version = "0.10.1", default-features = false, features = ["worker"] }
```
...
```toml
forge = { version = "0.10.1", default-features = false, features = ["gateway", "jobs", "otel"] }
```
...
```toml
forge = { version = "0.10.1", default-features = false, features = [
