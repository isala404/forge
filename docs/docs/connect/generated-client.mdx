...
| `status`   | `'pending' \| 'claimed' \| 'running' \| 'completed' \| 'failed' \| 'cancelled'` | Current job status.                        |
...
| `status`     | `'pending' \| 'running' \| 'sleeping' \| 'waiting' \| 'completed' \| 'failed'`   | Overall workflow status.                                 |
