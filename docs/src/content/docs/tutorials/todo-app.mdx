...
This is the Rust version. The same app exists in Node and Python in the
[todoapp example](https://github.com/isala404/forge/tree/main/examples/todoapp), where
every method has a `forge.kvSet(...)` or `forge.kv_set(...)` equivalent.
