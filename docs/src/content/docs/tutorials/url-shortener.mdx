...
This tutorial follows the canonical Python [link shortener](https://github.com/isala404/forge/tree/main/examples/linksapp). The examples directory also has one small application for each other supported language.
